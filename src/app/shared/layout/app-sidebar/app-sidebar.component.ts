...
type NavItem = {
  ...
  path?: string;
  new?: boolean;
  itemFor?: string[]; // Optional property to specify roles that can see this item
...
export class AppSidebarComponent {
  ...
  navItems: NavItem[] = [
    ...
    },
    {
      ...
      itemFor: ["teacher", "student"],
    },
    {
      icon: `<svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="size-5"><path d="M12 2C9.79086 2 8 3.79086 8 6V8H5C3.89543 8 3 8.89543 3 10V19C3 20.1046 3.89543 21 5 21H19C20.1046 21 21 20.1046 21 19V10C21 8.89543 20.1046 8 19 8H16V6C16 3.79086 14.2091 2 12 2Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M8 8V6C8 4.34315 9.34315 3 11 3H13C14.6569 3 16 4.34315 16 6V8" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" /><path d="M12 12.5C13.3807 12.5 14.5 11.3807 14.5 10C14.5 8.61929 13.3807 7.5 12 7.5C10.6193 7.5 9.5 8.61929 9.5 10C9.5 11.3807 10.6193 12.5 12 12.5Z" stroke="currentColor" stroke-width="1.5" /></svg>`,
  ...
  get isTeacher(): boolean {
    return this.authService.getUserRole()?.toLowerCase() === "teacher";
  }

  get isStudent(): boolean {
    return this.authService.getUserRole()?.toLowerCase() === "student";
  }
